...
class number_of_instances:
    """Prints the number of instances created"""

    number_of_instances = 0

    def __init__(self):
        """Increments the number of instances created"""
        number_of_instances += 1
        print("number_of_instances: {}".format(number_of_instances))
        return number_of_instances

    def __del__(self):
        """Decrements the number of instances created"""
        number_of_instances -= 1
        print("number_of_instances: {}".format(number_of_instances))
        return number_of_instances
